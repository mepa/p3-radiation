pro haloMassRedshift, sstart, send, step
            ...
            for ii=0, params.nxb-1 do begin
                for jj=0, params.nyb-1 do begin
                    for kk=0, params.nzb-1 do begin
                        ...
                        ; let's center it on minimum grav potential!
                        ...
                        ; let's center it on maximum baryonic density!
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
     ...
     print, "GPOT Center: ", min_x_gpot, min_y_gpot, min_z_gpot
     print, "DENS Center: ", max_x_dens, max_y_dens, max_z_dens
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; Sum quantities into bins
    ...
    baryon_mass = dblarr(num_bins+1L) 
    pde_mass = dblarr(num_bins+1L)
    volume = dblarr(num_bins+1L)
    total_mass = dblarr(num_bins+1L)

    radius = dblarr(num_bins+1L)
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; Find the virial mass/radius
    ...
    printf, lun1, FORMAT='(I,F,E,E,E,E,E,E,E)', number, redshift, R200, M200, R200_approx, M200_approx, x_center, y_center, z_center
