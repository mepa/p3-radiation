...
int main(int argc, char *argv[])
{
  ...
  cout << "N_dot_Hminus = " << N_dot_Hminus[0] << " " << N_dot_Hminus[1] << " " << N_dot_Hminus[2] << " " << N_dot_Hminus[3] << " " << N_dot_Hminus[4] << endl;
  cout << "N_dot_H2 = " << N_dot_H2[0] << " " << N_dot_H2[1] << " " << N_dot_H2[2] << " " << N_dot_H2[3] << " " << N_dot_H2[4] << endl;
  cout << "N_dot_H = " << N_dot_H[0] << " " << N_dot_H[1] << " " << N_dot_H[2] << " " << N_dot_H[3] << " " << N_dot_H[4] << endl;
  cout << "N_dot_He = " << N_dot_He[0] << " " << N_dot_He[1] << " " << N_dot_He[2] << " " << N_dot_He[3] << " " << N_dot_He[4] << endl;
  cout << "N_dot_Heplus = " << N_dot_Heplus[0] << " " << N_dot_Heplus[1] << " " << N_dot_Heplus[2] << " " << N_dot_Heplus[3] << " " << N_dot_Heplus[4] << endl;
